...
/**
 * This class showcases the use of StructuredTaskScope.ShutdownOnSuccess. The
 * scope.join() method will wait till the first "successful" thread forked from
 * the scope terminates and send cancellation requests to the rest of the
 * threads
 */
