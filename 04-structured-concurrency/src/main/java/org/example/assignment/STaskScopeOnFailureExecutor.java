...
/**
 * This class showcases the use of StructuredTaskScope.ShutdownOnFailure. The
 * scope.join() method will wait till the first "unsuccessful" thread forked
 * from the scope to terminate and then send cancellation requests for the rest.
 */
