...
/**
 * This class showcases the use of StructuredTaskScope used in default fashion.
 * By default, the scope.join() method will wait for all the threads forked from
 * scope to terminate ( whether successful or not)
 *
 */
public class STaskScopeExecutor {
	 ...
	 */
	private static Map<String, TaskResponse> execute(Collection<LongRunningTask> tasks) throws InterruptedException {
